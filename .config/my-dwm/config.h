...
// nord theme
/* color choices #2e3440 #e5e9f0  #88c0d0 #d08770 #8fbcbb */
...
const char *spfilebrowser[]  = {"st", "-n", "lf", "-g", "120x34","-e","/usr/bin/lf"};
...
/* tagging */
static const char *tags[] = { "\uf120  :1", "\uf269  :2", "\uf121  :3", "\uf115  :4", "\uf1fc  :5", "\ue7c5  :6", "\ufa00  :7", "\uf499  :8", "\uf661  :9" };
...
static const Rule rules[] = {
	...
	*/
	...
	{ "Warpinator",               NULL,                  NULL,       	    0,            1,           0,         0,        -1 },
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_equal,	spawn,		SHCMD("amixer -D pulse sset Master 5%+") },
	...
	{ MODKEY|ShiftMask,		XK_r,		spawn,		SHCMD("kitty --name lf lf") },
	{ MODKEY,		        XK_r,		spawn,		SHCMD("kitty --name lf lf") },
