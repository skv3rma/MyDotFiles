...
config.bind(',dp', 'open -t dropbox.com')
config.bind(',gm', 'open -t gmail.com')
config.bind(',ku', 'open -t ee.kumuluz.com')
config.bind(',lh', 'open -t http://localhost:8080/')
config.bind(',lo', 'open -t localhost:8080')
config.bind(',po', 'open -t getpocket.com')
config.bind(',to', 'open -t tomee.apache.org/latest/examples')
config.bind(',ut', 'open -t youtube.com')
config.bind(',ps','open -t https://getpocket.com/edit?url={url}')
...
## Type: QssColor
c.colors.statusbar.caret.bg = "#ffffff"

## Foreground color of the statusbar in caret mode.
## Type: QssColor
c.colors.statusbar.caret.fg = "#2980b9"
...
## Type: QssColor
c.colors.statusbar.command.bg ="#2980b9"
...
## Type: QtColor
c.colors.tabs.odd.fg = "#252931"

## Background color of selected even tabs.
## Type: QtColor
c.colors.tabs.selected.even.bg = "#2980b9"
...
## Type: QtColor
c.colors.tabs.selected.odd.bg ="#2980b9"
